...
PC1 (the fat component) was most strongly correlated with sex(r=-0.22), exercise_scaled(r=-0.21), age_scaled (r=0.13) and carbs_index_scaled (r=-0.08). All the regression models predicted PC1 very poorly. The regression tree model produced the highest R2 and lowest MSE (R2=0.04; MSE=0.35).

(Continue here
Also include the settings for the different models)
